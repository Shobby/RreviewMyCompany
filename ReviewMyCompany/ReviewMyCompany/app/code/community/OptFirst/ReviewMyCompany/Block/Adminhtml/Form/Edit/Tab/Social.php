<?php
class OptFirst_ReviewMyCompany_Block_Adminhtml_Form_Edit_Tab_Social extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $form->setHtmlIdPrefix('social_');
        $form->setFieldNameSuffix('social');
