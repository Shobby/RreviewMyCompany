...
class OptFirst_ReviewMyCompany_Block_Adminhtml_Form_Edit_Renderer_Label
...
implements Varien_Data_Form_Element_Renderer_Interface
{
    ...
    public function render(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $html .= ' <label for="' . $htmlId . '" class="normal">' . Mage::helper('optfirst_reviewmycompany')->__('Do not change value') . '</label>';
